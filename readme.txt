...
* Option to select Post/Page Elements to copy.
* Option to add Title Prefix.
* Option to add Title Suffix.
* Option to select duplicate Post/Page Status.
* Option to Redirect after click on Clone.
* Option to select Allowed User Role Permission.
* Option to select Allowed Post Type Permission.

== Installation ==

The plugin is simple to install:

 * Download coding-bunny-easy-duplicate-post.zip
 * Unzip
 * Upload coding-bunny-easy-duplicate-post directory to your /wp-content/plugins directory
...
= How to create the duplicate of a page or a post? =
 ...
 5. After you click on "Clone" link, then duplicate post/page will be created and saved as draft, make the changes you wish and hit publish.
